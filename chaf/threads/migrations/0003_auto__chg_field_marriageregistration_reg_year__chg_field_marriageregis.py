...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MarriageRegistration.reg_year'
        db.alter_column(u'threads_marriageregistration', 'reg_year', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'MarriageRegistration.reg_number'
        db.alter_column(u'threads_marriageregistration', 'reg_number', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'BirthRegistration.reg_number'
        db.alter_column(u'threads_birthregistration', 'reg_number', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'MarriageRegistration.reg_year'
        db.alter_column(u'threads_marriageregistration', 'reg_year', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'MarriageRegistration.reg_number'
        db.alter_column(u'threads_marriageregistration', 'reg_number', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'BirthRegistration.reg_number'
        db.alter_column(u'threads_birthregistration', 'reg_number', self.gf('django.db.models.fields.IntegerField')())
